...
def validarSistemaArchivos():
    ...
    version = leerCadena(10, 4)                     #Lee la cadena de versión desde la posición 10 con longitud 5 bytes
    etiqueta = leerCadena(20, 19)                   #Lee la cadena de etiqueta del volumen desde la posición 20 con longitud 16 bytes
    ...
    cantidadclusters = leerEntero(45, 4)            #Lee un entero que representa la cantidad de clusters que mide el directorio desde la posición 44 con longitud 4 bytes
    clustersUnidad = leerEntero(50, 4)                         #Lee un entero que representa la cantidad de clusters que mide toda la unidad desde la posición 48 con longitud 4 bytes
...
def copiarArchivo(nombre_archivo):
    ...
    #Adquirimos el semáforo antes de acceder al archivo
    semaphore.acquire()
    ...
    try:
        ...
        semaphore.release()               #Liberamos el semáforo después de la operación
