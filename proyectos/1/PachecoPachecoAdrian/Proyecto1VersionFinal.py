...
# Extrae el superbloque, donde definimos nuestras especificaciones del sistema FiUnamFS
...
# Definicion de Hilos empleado para el punto numero 5 del poyecto 
...
def menu():
    while True:
        ...
        log_message("7) Salir")
        log_message("Digite solo el numero")
