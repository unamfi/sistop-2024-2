...
def validar_FiUnamFS():
    ...
    if os.path.getsize(ruta_FiUnamFS) != 1440*1024:
        messagebox.showerror("Error", "El archivo no tiene el tamaño correcto. El tamaño debe ser de 1440 Kilobytes.")
        return False
    with open(ruta_FiUnamFS, "rb") as f:
        ...
        if version_FiUnamFS != "24-2":
            messagebox.showerror("Error", "La versión de la implementación no es correcta.")
            return False
    ...
    messagebox.showinfo("Éxito", "Sistema de archivos FiUnamFS cargado exitosamente.")
    return True
...
def fiunamfs_to_local():
    ...
    try:
        ...
        with open(ruta_local, "wb") as f_local:
            f_local.write(info)
        messagebox.showinfo("Éxito", "Archivo copiado exitosamente.")
